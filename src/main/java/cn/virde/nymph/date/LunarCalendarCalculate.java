...
public Week toWeek() { 
 ...
 iOffsetDays += LunarCalendarCalculate.iGetSNewYearOffsetDays(iYear, iMonth, iDay); 
...
public LunarDate toLunarDate() { 
 ...
 LunarDate ld; 
 iDate = Integer.parseInt(LunarCalendarCalculate.sCalendarSolarToLundar(this.iYear, this.iMonth, this.iDay));
 iYear = iDate / 10000; 
...
public CnWeek toWeek() { 
 ...
 iOffsetDays += LunarCalendarCalculate.iGetLNewYearOffsetDays(iYear, iMonth, iDay); 
...
public SolarDate toSolarDate() { 
 int iYear, iMonth, iDay, iDate; 
 SolarDate sd; 
 iDate = Integer.parseInt(LunarCalendarCalculate.sCalendarLundarToSolar(this.iYear, this.iMonth, this.iDay));
 iYear = iDate / 10000; 
 iMonth = iDate % 10000 / 100; 
 iDay = iDate % 100; 
